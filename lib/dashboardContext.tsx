...
// ─── Initial State (vacío; el BI se alimenta 100% de GET /api/config/dynamic vía AppContext.systemConfig) ───
export const initialData: DashboardData = {
  empresa: '',
  mes: '',
  comercial: {
    presupuestos_creados: { valor: 0, meta: 0 },
    valor_presupuestos: { valor: 0, meta: 0 },
  },
  operaciones: {
    tiempo_efectivo: { valor: 0, meta: 0, unidad: '%' },
    ordenes_ejecutadas: { valor: 0, meta: 0 },
    evolucion_tiempo: [],
  },
  calidad: {
    cancelacion_tecnica: { valor: 0, meta: 0, unidad: '%' },
    nps: { valor: 0, meta: 0, unidad: '%' },
    deficiencias_cerradas: { valor: 0, meta: 0, unidad: '%' },
  },
};
...
export function DashboardProvider({ children }: { children: ReactNode }) {
  ...
  // El estado BI (tableros/indicadores/datos) se alimenta 100% de GET /api/config/dynamic
  // vía AppContext.systemConfig. Este contexto solo mantiene data legacy para CSV/export/modal.
