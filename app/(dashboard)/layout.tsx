...
export default async function DashboardGroupLayout({
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-slate-50">
      {/* Sidebar */}
      <aside className="flex flex-col w-64 flex-shrink-0 border-r border-slate-200 bg-white shadow-sm">
        <div className="flex items-center gap-3 px-5 py-6 border-b border-slate-100">
          <div className="flex justify-center items-center w-10 h-10 rounded-xl bg-blue-600 text-white shadow-lg shadow-blue-500/20">
