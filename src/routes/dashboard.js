...
// ── Mock data por empresa ──────────────────────────────────────────────────────
// Estructura idéntica a KPIData del frontend (lib/kpiData.ts).
// Cuando conectemos la DB, reemplazaremos estos objetos con queries reales.
...
const MOCK_DATA = {
  SOLVEX: {
    comercial: {
      contactos_efectivos: {
        ...
        meta_total: 50, logrado_total: 17, unidad: 'contactos',
        semanas: [
      ...
      presupuestos_cantidad: {
        ...
        meta_total: 100, logrado_total: 39, unidad: 'presupuestos',
        semanas: [
      ...
      presupuestos_valor: {
        ...
        meta_total: 250000000, logrado_total: 121700000, unidad: 'moneda',
        semanas: [
    ...
    operaciones: {
      tiempo_efectivo: {
        ...
        meta_total: 70, logrado_total: 46.5, unidad: 'porcentaje',
        semanas: [
      ...
      ordenes_ejecutadas: {
        ...
        meta_total: 400, logrado_total: 167, unidad: 'ordenes',
        semanas: [
      ...
      cancelacion_ordenes: {
        ...
        meta_total: 0, logrado_total: 5, unidad: 'ordenes',
        semanas: [
    ...
    calidad: {
      cancelacion_tecnica: {
        ...
        meta_total: 10, logrado_total: 0, unidad: 'porcentaje_inverso',
        semanas: [
      ...
      deficiencias: {
        ...
        meta_total: 275, logrado_total: 45, unidad: 'porcentaje_inverso',
        semanas: [
      ...
      nps: {
        ...
        meta_total: 250, logrado_total: 85, unidad: 'porcentaje',
        semanas: [
      ...
      producto_consumido: {
        ...
        meta_total: 500, logrado_total: 95, unidad: 'cantidad',
        semanas: [
  ...
  'EL MEJOR': {
    comercial: {
      contactos_efectivos: {
        titulo: 'Contactos Efectivos (Nuevos Potenciales)',
        meta_total: 60, logrado_total: 58, unidad: 'contactos',
        semanas: [
      ...
      presupuestos_cantidad: {
        titulo: 'Cantidad de Presupuestos Creados',
        meta_total: 100, logrado_total: 114, unidad: 'presupuestos',
        semanas: [
      ...
      presupuestos_valor: {
        titulo: 'Valor de Presupuestos ($)',
        meta_total: 300000000, logrado_total: 312000000, unidad: 'moneda',
        semanas: [
    ...
    operaciones: {
      tiempo_efectivo: {
        titulo: 'Tiempo Efectivo de Trabajo (%)',
        meta_total: 350, logrado_total: 368, unidad: 'porcentaje',
        semanas: [
      ...
      ordenes_ejecutadas: {
        titulo: 'Ordenes Programadas vs Ejecutadas',
        meta_total: 400, logrado_total: 421, unidad: 'ordenes',
        semanas: [
      ...
      cancelacion_ordenes: {
        titulo: 'Cancelacion de Ordenes de Trabajo',
        meta_total: 0, logrado_total: 3, unidad: 'ordenes',
        semanas: [
          { name: 'Week 1', logrado: 1, meta: 0 },
    ...
    calidad: {
      cancelacion_tecnica: {
        titulo: 'Cancelacion por Causas Tecnicas (%)',
        meta_total: 10, logrado_total: 4, unidad: 'porcentaje_inverso',
        semanas: [
      ...
      deficiencias: {
        titulo: 'Deficiencias y Seguimiento (%)',
        meta_total: 275, logrado_total: 180, unidad: 'porcentaje_inverso',
        semanas: [
      ...
      nps: {
        titulo: 'Satisfaccion NPS (%)',
        meta_total: 250, logrado_total: 360, unidad: 'porcentaje',
        semanas: [
      ...
      producto_consumido: {
        titulo: 'Producto Sugerido vs Consumido',
        meta_total: 500, logrado_total: 487, unidad: 'cantidad',
        semanas: [
 ...
 *
 * Devuelve los KPIs completos (comercial + operaciones + calidad) para
 * la empresa indicada en el path param.
 *
 * Actualmente usa datos mock; cuando se conecte la DB, se reemplazan
 * los objetos de MOCK_DATA con consultas a Prisma / SQLite.
 */
router.get('/:empresa', (req, res) => {
  // Normalizar el nombre: uppercase y trim
  const empresaKey = decodeURIComponent(req.params.empresa).trim().toUpperCase();

  const data = MOCK_DATA[empresaKey];

  if (!data) {
    // Fallback a SOLVEX si la empresa no existe en el mock
    return res.json({
      success: true,
      empresa: empresaKey,
      fallback: true,
      data: MOCK_DATA['SOLVEX'],
    });
  }

  res.json({ success: true, empresa: empresaKey, data });
});
